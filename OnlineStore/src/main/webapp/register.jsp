                                    ...
                                    <div class="col-1">
                                        <div class="woocommerce-billing-fields">
                                            ...
                                            <p id="billing_company_field" class="form-row form-row-wide">
                                                ...
                                                <input type="text" value="" placeholder="" id="billing_company" name="email" class="input-text ">
                                            </p>
                                            <p id="billing_email_field" class="form-row form-row-first validate-required validate-email">
                                                <label class="" for="billing_email">Password <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="password" value="" placeholder="" id="billing_email" name="pass" class="input-text ">
                                            </p>
                                        ...
                                        <div class="woocommerce-shipping-fields">
                                            ...
                                            <div class="shipping_address" style="display: block;">
                                                ...
                                                <p id="shipping_address_1_field" class="form-row form-row-wide address-field validate-required">
                                                    ...
                                                    <input type="text" value="" placeholder="Street address" id="shipping_address_1" name="addr" class="input-text ">
                                                </p>
                                                ...
                                                <p id="shipping_postcode_field" class="form-row form-row-last address-field validate-required validate-postcode" data-o_class="form-row form-row-last address-field validate-required validate-postcode">
                                                    ...
                                                    <input type="text" value="" placeholder="Postcode / Zip" id="shipping_postcode" name="pincode" class="input-text ">
                                                </p>
