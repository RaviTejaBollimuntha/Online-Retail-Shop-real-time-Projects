                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <li><a href="Signout.jsp"><i class="fa fa-user"></i> SignOut</a></li>
                        </ul>
                    </div>
                </div>
...
%>
                                            ...
                                            <td class="product-quantity">
                                                <div class="quantity buttons_added">                                                   
                                                    <input type="number" size="4" name="quantity"  onchange="this.form.submit()" class="input-text qty text" title="Qty" value=<%=val.get(k) %> min="0" step="1" >                                                    
                                                </div>
                                            </td>
...
<%
	...
	%>
	                                    <form action="index.jsp" method="POST">
                                            <input type="submit" value="Please Add Items to Cart">
                                        </form>  
	<%
}
	%> 
